---
title: SCORM出力の生成
description: 製品トレーニングと学習でSCORM出力を生成する方法を説明します
feature: Authoring
role: User
...
SCORM出力を生成するには、次の手順を実行します。

1. 環境設定に基づいてSCORM出力に必要なすべての設定を行った後、SCORM プリセットページのツールバーに移動します。
1. 「**出力を生成**」を選択します。
...
1. 出力をダウンロードまたはプレビューするには、それぞれ&#x200B;**出力をダウンロード**&#x200B;または&#x200B;**出力をプレビュー**&#x200B;を選択します。
   ...
   >[!NOTE]
   >
   > SCORM プレビューは、SCORM出力を生成するときに使用できます。 コースがフォント、スタイルシート、または埋め込みコンテンツの外部ドメインに依存している場合は、[SCORM プレビューの設定](../lc-config-guide/guides-scorm-preview-config.md)で許可されるドメインを設定します。
