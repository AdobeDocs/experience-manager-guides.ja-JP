...
- **ガイド AI**
  ...
  >[!NOTE]
  >
  > お客様の環境でGuides AI機能を使用する場合は、カスタマーサクセス チームにお問い合わせください。 一度に有効にできるAI エクスペリエンスは、ガイド AIまたはAI アシスタントのいずれかです。

  「**ガイド AI**」トグルを選択して、Experience Manager Guidesでこの機能を有効にします。この機能を無効にするには、選択解除します。

  このオプションを有効にすると、ホームページのナビゲーションバーとエディターインターフェイスのタブバーからガイド AI機能にアクセスできるようになります。 トピックのAIが提案したタグを生成する方法について詳しくは、[&#x200B; ガイド AIの基本を学ぶ](../user-guide/guides-ai.md)を参照してください。
