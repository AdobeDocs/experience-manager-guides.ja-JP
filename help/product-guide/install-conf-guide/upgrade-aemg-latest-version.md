...
現在のバージョンのExperience Manager Guidesをバージョン 5.2.0にアップグレードできます。
...
- [バージョン 5.2.0へのアップグレード](#upgrade-to-version-510)
...
>[!NOTE]
>
>5.2.0にアップグレードする場合は、Experience Manager Guidesのバージョン 5.0.0、5.0.3、5.1.0または5.1.3を使用する必要があります。 5.2.0 リリースのアップグレードプロセスは、5.1.0 リリースと同じ手順に従います。

Experience Manager Guides 5.2.0のアップグレードプロセスを開始する前に、次のことを確認してください。

1. Experience Manager Guides バージョン 5.0.0、5.0.3、5.1.0または5.1.3にアップグレードしました。
...
>[!NOTE]
>
> ドキュメントに従いながら、`/oak:index/damAssetLucene`のプロパティ（`reindex=true`と`reindex-async=true`）の両方が保存操作で同時に更新されていることを確認してください。
