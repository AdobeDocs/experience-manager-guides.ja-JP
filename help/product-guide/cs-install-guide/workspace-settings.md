...
一般設定では、エディターを使用するための設定を指定できます。 このタブには、「**AI アシスタント**」、「**オーサリング**」、「**引用文献**」、「**条件**」、「**8&rbrace;HTMLエディター**」、「ラーニングコンテンツ **」、「** スペルチェック **」の 7 つのセクションがあります。**
...
- **ラーニングコンテンツ**：この設定を使用すると、Experience Manager Guides インスタンスの製品トレーニングおよびラーニングコンテンツ機能を有効または無効にできます。 **学習コンテンツを有効にする** 切替スイッチを使用して、フォルダープロファイルレベルで機能を有効または無効にします。 デフォルトでは、この機能はすべてのインスタンスで無効のままです。

  [&#x200B; 製品トレーニングおよび学習コンテンツ &#x200B;](../learning-content/intro.md) 機能の詳細情報

  次の機能/オプションは、学習コンテンツ設定が有効な場合にのみ使用できます。

   - **コースオーサリング**：エディターとホームページの両方でコースを作成および管理するオプションを有効にします。
   - **SCORM テンプレート**: エディターの *出力テンプレート* の下に SCORM テンプレートを作成するオプションを有効にします。
   - **コンテンツテンプレートと出力プリセット**: Workspace設定ダイアログのコンテンツテンプレートと出力プリセットの設定オプションを有効にします。

ラーニングコンテンツが無効になっている場合、上記のオプションはすべてExperience Manager Guides インターフェイスで使用できなくなります。

詳しくは、[&#x200B; フォルダープロファイルの設定 &#x200B;](../lc-config-guide/lc-folder-profile.md) を参照してください。

- **HTML エディター**：この設定では、ラーニングコンテンツの場合、HTML ベースのオーサリング用にエディターを設定できます。 この設定に含まれる主要な設定オプションは次のとおりです。
