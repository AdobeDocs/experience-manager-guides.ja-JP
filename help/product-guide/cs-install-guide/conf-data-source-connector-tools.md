...
Generic REST Client、Salsify、Akeneo、Microsoft Azure DevOps Boards （ADO）などの一部のコネクタでは、異なるURLにもとづいて複数のリソースを追加または使用できます。 次に、それらを接続して、生成AIを使用してコンテンツスニペットやトピックを作成します。
