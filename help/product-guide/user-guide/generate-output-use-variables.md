---
title: 宛先パス、サイトパス、サイト名、ファイル名の各オプションを設定するための変数を使用する
...
# 宛先パス、サイトパス、サイト名、ファイル名の各オプションを設定するための変数を使用する


AEM Sitesまたは PDF で出力を生成する際には、変数を使用して、出力先パス、サイトパス、AEM サイト名、PDF ファイル名のオプションを定義できます。 これらのオプションは、変数の 1 つまたは組み合わせを使用して定義できます。
