...
- 2023 年 10 月リリース以降を使用している場合は、クラウドサービスのインストールおよび設定ガイドで、[ ユーザーインターフェイスからのデータソースコネクタの設定 ](../cs-install-guide/conf-data-source-connector-tools.md) の方法を参照してください。

- 2023 年 7 月または 2023 年 9 月のリリースを使用している場合は、クラウドサービスのインストールおよび設定ガイドで [ データソースコネクタの設定 ](../cs-install-guide/conf-data-source-connector.md) の方法を参照してください。
