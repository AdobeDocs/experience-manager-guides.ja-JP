...
1. 「**追加**」を選択します。
   ...
   ![新規](images/new-aem-sites-dialog-box.png){width="300"}
...
- **オンプレミスソフトウェア**: オンプレミスソフトウェア用のAEM Sites テンプレート ](../install-guide/download-install-aem-sites-templates.md)を[ ダウンロードしてインストールする方法について詳しく説明します。
...
![新規](images/aem-sites-new-config.png){width="650"}
...
![新規](images/aem-sites-preset-legacy-config.png){width="500"}
...
| AEM Sitesオプション | 説明 |
| --- | --- |
| サイト名 | 出力がAEM リポジトリに保存されるサイト名。<br><br>AEM リポジトリ内のノードは、ここで指定した名前で作成されます。 サイト名を指定しない場合、サイトノードはDITA マップファイル名で作成されます。<br><br>ここで指定したサイト名は、ブラウザータブのタイトルとしても使用されます。<br><br> サイト名の設定時に変数を使用することもできます。 詳細については、[宛先パス、サイト名、またはファイル名のオプションを設定するための変数の使用](./generate-output-use-variables.md)を参照してください |
...
| に基づいたページ名の生成 | **トピックのファイル名**: トピックのファイル名を使用して、サイト URLを作成します。<br> **トピックタイトル**：トピックのタイトルを使用して、Experience Manager サイト名を作成します。<br> **メモ**：このオプションは、お使いの環境で有効になっている場合にのみ使用できます。 Adobe カスタマーサクセスチームに連絡して有効にしましょう。 使用可能な場合、このプリセットで選択された値は、フォルダーレベルの`aemsite.pagetitle`設定を上書きします。 詳しくは、[既存のAEM サイト出力のカスタマイズ ](../install-conf-guide/customize-aem-site-output.md)を参照してください |
...
![新規](images/aem-sites-content-tab.png){width="650"}
