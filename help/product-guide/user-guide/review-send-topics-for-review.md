...
1. **割り当て先** ドロップダウンフィールドで、トピックをレビューのために送信するレビュー担当者を選択します。 入力時に、選択したプロジェクト内のメンバー名または役割名で検索することもできます。

   「*割り当て先* フィールドは、「*プロジェクト*」フィールドでアクティブなプロジェクトを選択した後にのみ有効になります。 メンバーまたは役割のリストは、選択したプロジェクトに基づいて取得されます。 プロジェクトが選択されていない場合、「*割り当て先*」フィールドは無効のままになります。

   レビュータスクは、プロジェクトの個々のユーザーまたはユーザーグループに割り当てることができます。 レビュータスクを個々のユーザーに割り当てることができるのは、プロジェクトの管理者グループに属する場合のみです。それ以外の場合は、ユーザーグループが「*割り当て先*」フィールドに表示されるだけです。
...
1. 「**次へ**」を選択します。
   ...
   >[!NOTE]
   >
   > 「**次へ**」ボタンは、「*タイトル*」、「*プロジェクト*」、「*割り当て先*」、「*期限* など、すべての必須フィールドの詳細を入力した後にのみ有効になります。
