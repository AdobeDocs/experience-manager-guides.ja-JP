...
- *同じ場所にドラッグ&amp;ドロップ*：既存のファイルを&#x200B;**上書き**、**両方のファイルを保持\（s\）**&#x200B;するオプションが与えられます。
...
*同じ場所にあるファイルをドラッグ&amp;ドロップ*：既存のファイルを&#x200B;**上書き**&#x200B;するオプションが与えられます。
...
*別の場所にあるファイルをドラッグ&amp;ドロップ*：既存のファイルを&#x200B;**上書き**、**ファイルを新しい場所**&#x200B;に移動するオプションが与えられます。
