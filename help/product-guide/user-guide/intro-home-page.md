...
- **その他のアクション**：追加のオプションへのアクセスを提供します。 このボタンを選択すると、次のオプションを含むメニューが開きます。
  ...
  - **Workspace settings**: **Workspace settings** ダイアログに移動します。 詳しくは、[Workspace設定の設定](../cs-install-guide/workspace-settings.md)を参照してください。
    ...
    >[!NOTE]
    >
    > ホームページでは、バージョン 5.2以降のCloud Servicesおよびオンプレミス設定で、Workspace設定のオプションを利用できます。 バージョン 5.2より前のオンプレミス設定では、「その他のアクション」オプションはホームページで使用できません。 ただし、エディターインターフェイスとマップコンソールから、その他のオプション/設定に移動して、関連する設定にアクセスできます。
...
>[!NOTE]
>
> リポジトリは、2025.11.0 リリース以降のクラウドサービス設定と5.2 リリース以降のオンプレミス設定の左側のパネルで使用できます。 5.2 バージョンより前のオンプレミス設定の場合、リポジトリには引き続きエディターインターフェイスからアクセスできます。
...
- **アピアランス**:「アピアランス」タブには、アプリケーションのテーマとコンテンツ編集領域のソースビューを選択するオプションが表示されます。 このタブを使用して、次の設定を行います。
  ...
  - **常にエクスプローラーでファイルを検索する**：このオプションを選択すると、エディターで編集する際にリポジトリ内のファイルの場所が表示されます。
    ...
    >[!NOTE]
    >
    >- Cloud Serviceの2025.11.0 リリースとオンプレミスの5.2.0 リリースから、設定&#x200B;**リポジトリ内のファイルを常に検索**&#x200B;の名前が&#x200B;**エクスプローラー内のファイルを常に検索**&#x200B;に変更されました。 5.2 リリースより前のオンプレミス設定の場合は、「常にリポジトリ内のファイルを探す」として引き続き使用できます。
    >- 2026.09.0 リリース以降、**ファイルとフォルダーのページ分割による読み込み**&#x200B;はデフォルトで有効になっています。 この機能が有効になっている場合、**常にエクスプローラー**&#x200B;でファイルを検索する機能は、ユーザーの環境設定では使用できません。 エクスプローラー環境設定の「ファイルを常に探す」を使用できるようにするには、カスタマーサクセスチームに連絡して、ファイルとフォルダーの「ページ分割された読み込み」設定を無効にします。 詳しくは、[&#x200B; ファイルとフォルダーのページ分割による読み込み](./web-editor-other-features.md#paginated-loading-of-files-and-folders)を参照してください。
