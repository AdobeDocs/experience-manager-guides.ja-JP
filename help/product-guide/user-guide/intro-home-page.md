...
- **ガイド AI**: Adobe CX Enterprise Coworkerのインテリジェントなエージェンティック スマート タグ スキルをエディターに取り込み、自然で会話的なコンテンツ タグ付けを可能にします。 コンテンツを分析し、関連するタグを提案し、一貫性のある正確なメタデータを最小限の労力で適用できます。 提案されたタグを確認し、選択を確定する前に適用または却下することを選択できます。 [Guides AI](../user-guide/guides-ai.md)は、タグ付けプロセスを合理化し、コンテンツの整理と見つけやすさを向上させます。
