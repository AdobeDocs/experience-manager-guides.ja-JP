...
| Salesforceオプション | 説明 |
| --- | --- |
| パブリッシュプロファイル | ドロップダウンを使用して、管理者が設定したSalesforce接続プロファイルから選択します。 管理者が公開プロファイルを作成する方法について詳しくは、「{ タブバー **」セクションで、** オンプレミス **の** 設定 **として表示される** 0}Workspace設定 [&#x200B; を参照してください。](./web-editor-features.md#tab-bar) |
