...
| Post生成のワークフロー | このオプションを選択すると、新しい「Post生成ワークフロー」ドロップダウンリストが表示され、Adobe Experience Managerで設定されたすべてのワークフローが含まれます。 出力の生成が完了したら、実行するワークフローを選択する必要があります。<br><br>**注意**:Cloud Serviceのインストールおよび設定ガイドにある [ 出力後の生成ワークフローをカスタマイズする ](../cs-install-guide/customize-workflows.md#id17A6GI004Y4) 方法の節について詳しく説明します。 |
...
| オプション |説明 |
| — | — |
|記事の本文からトピックの見出しを削除します。|このオプションを選択すると、公開済みの出力の記事からトピックの見出しが削除されます。 |
|下書きとしてアップロード | トピックをアップロードしてドラフトとして共有してからユーザーが使用できるようにするには、このオプションを選択します。|
|画像をアップロード| トピック内の画像を公開出力に含める場合は、このオプションを選択します。|
|リンクされたドキュメントをアップロード|トピックにリンクされたドキュメントを公開済みの出力に含めるには、このオプションを選択します。|
...
| Post生成のワークフロー | このオプションを選択すると、Adobe Experience Managerで設定されたすべてのワークフローを含む新しいPost生成ワークフロードロップダウンリストが表示されます。 出力生成ワークフローの完了後に実行するワークフローを選択する必要があります。<br> インストールおよび設定ガイドの [ 出力後の生成ワークフローをカスタマイズする方法の詳細 ](../install-guide/customize-workflows.md#id17A6GI004Y4) 節です。 |
>[!TIP]
> 
