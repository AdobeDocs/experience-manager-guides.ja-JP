...
| ServiceNow オプション | 説明 |
| --- | --- |
| パブリッシュプロファイル | ドロップダウンを使用して、管理者が設定したServiceNow接続プロファイルから選択します。 管理者が公開プロファイルを作成する方法について詳しくは、[左パネル ](./web-editor-features.md#id2051EA0M0HS) セクションの「**Workspace settings**」（バージョン 5.2 **より前の** オンプレミス設定では&#x200B;**Settings**&#x200B;と表示）機能の説明を参照してください。 |
...
| Salesforceオプション | 説明 |
| --- | --- |
| パブリッシュプロファイル | ドロップダウンを使用して、管理者が設定したSalesforce接続プロファイルから選択します。 管理者が公開プロファイルを作成する方法について詳しくは、[ タブバー](./web-editor-tab-bar.md)の&#x200B;**Workspace settings** （**オンプレミス設定の場合** Settings **と表示）機能の説明を参照してください。** |
