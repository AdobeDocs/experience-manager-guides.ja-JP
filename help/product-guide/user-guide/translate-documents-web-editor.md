...
1. 次をクリック： **管理** タブをクリックします。 翻訳パネルには、 **使用可能な言語** リスト。
1. 次から： **使用可能な言語** 「 」リストで、プロジェクトを翻訳するロケールを選択します。 次を選択できます。 **すべて選択** をクリックして、プロジェクトを使用可能なすべての言語に翻訳します。
   ...
   >[!IMPORTANT]
   >
   > このリストには、言語フォルダーがソース言語と並行して作成される言語のみが表示されます。 ソース言語フォルダーから 1 レベル下のレベルなど、他のレベルで作成された言語フォルダーも表示されません。 すべてのターゲット言語フォルダーを、ソース言語フォルダーと同じレベルで作成してください。

   ![](images/translation-languages.png){width="300" align="left"}

1. また、次のいずれかのオプションを選択して、プロジェクトを翻訳できます。

   **なし** このオプションを選択すると、ファイルのデフォルトバージョンが翻訳されます。 このオプションはデフォルトで選択されています。
...
1. クリック **適用**. トピックと関連アセットの詳細が記載されたリストが表示されます。
