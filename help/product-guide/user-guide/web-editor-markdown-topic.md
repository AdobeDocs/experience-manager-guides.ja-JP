...
1. **新規トピック** ダイアログボックスで、次の詳細を入力します。
...
>[!NOTE]
>
> **検索と置換** 機能は、Markdown ファイルをリポジトリレベルで処理しません。 これには、マップまたはフォルダ内での Markdown ファイルの検索が含まれます。 ただし、Markdown エディター内では引き続き使用できます。 また、リポジトリ表示の **検索** オプションと **フィルター** オプションでは、Markdown ファイルは処理されません。
