...
1. Adobe Analytics の **テンプレート** ウィンドウで、 **+** 隣のアイコン **テンプレート** を選択します。 **PDFテンプレート**.
1. Adobe Analytics の **新規PDFテンプレート** ダイアログで、カスタムテンプレートを作成する基本として使用するファクトリテンプレートを選択します。 また、検索ボックスを使用して、テンプレートを検索することもできます。
1. テンプレートのタイトルを指定します。
