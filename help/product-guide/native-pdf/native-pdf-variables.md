...
![新しい変数を作成](assets/add-variable-default.png){width="800"}
...
1. 変数にカーソルを合わせて&#x200B;**オプション** メニューを表示し、**プレビュー** オプションを選択します。
   ...
   変数パネルからの![変数のプレビュー](assets/variables-panel-preview-default.png){width="550"}
...
1. **設定**&#x200B;を選択 <img alt= "設定アイコン" src="./assets/settings-icon.svg" width="25">で&#x200B;**変数セットの設定** ダイアログボックスを開きます。
   ![変数セットの設定](assets/configure-variable-set.png){width="550"}
...
![変数エディターからの変数プレビュー](assets/variables-editor-preview.png){width="550"}
