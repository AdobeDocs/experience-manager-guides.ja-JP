...
- Web エディタータブのタイトルは、ドット（。）の後に切り捨てられます。 キャラクター： (14372)
...
- Web エディターは、**レイアウト** ビューで特殊なスキーマを使用して新しい参照またはトピックを追加すると、アプリケーションエラーをスローします。 (14094)
...
- Web エディターにプレビューを表示しても、画像プレビューが表示されない。 (13454)
...
- ユーザーが&#x200B;**ユーザー環境設定**&#x200B;から明示的に設定していない場合でも、ロードマップ設定はWeb エディターに保持されます。 (11551)
...
- Adobe Experience Manager Guides バージョン 4.3.1を再インストールすると、Web エディターがアンインストールされます。 (14519)
...
- **AEM サイト** プリセットでは、Web エディターで`/content`階層外のテンプレートを選択できません。 (14260)
...
- 対称性の問題は、Web エディターの以前のバージョンと現在のバージョンのサイドレビューパネルで発生します。 (14156)
