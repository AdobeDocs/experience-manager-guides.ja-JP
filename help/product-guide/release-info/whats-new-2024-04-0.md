...
Experience Manager Guidesのクラウドパブリッシングサービスは、Adobe IMSのOAuth ベースの認証によって保護されるようになりました。 OAuth認証[&#128279;](../knowledge-base/publishing/configure-microservices-imt-config.md)を使用してマイクロサービスベースの公開を設定する方法について説明します。
