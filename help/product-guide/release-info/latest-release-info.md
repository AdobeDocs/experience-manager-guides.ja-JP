...
AMS またはオンプレミスへのインストールで使用できる最新の [!DNL AEM Guides] パッケージ、対応するAEM バージョン（前提条件）、パッケージのダウンロードリンクなどの役に立つ情報の一覧を以下に示します。 [!DNL AEM Guides] の最新のビルドのみを使用することをお勧めします。 何らかの理由で古いビルドへのアクセスが必要な場合は、アカウントのカスタマーサクセスマネージャーにお問い合わせください。
