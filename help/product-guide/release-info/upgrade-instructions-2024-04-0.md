---
title: リリースノート | Adobe Experience Manager Guides（2024.04.0 リリース）のアップグレード手順と修正された問題
description: 互換性マトリックスと、Adobe Experience Manager Guides as a Cloud Serviceの2024.04.0 リリースにアップグレードする方法について説明します。
