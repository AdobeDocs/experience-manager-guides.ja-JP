...
description: Adobe Experience Manager Guides 5.0.0 リリースの新機能と強化機能について説明します
role: Leader
...
# 5.0.0 リリース（2025年3月）の新機能

この記事では、Adobe Experience Manager Guidesのバージョン 5.0.0で導入された新機能と強化機能について説明します。

このリリースで修正された問題のリストについては、「[5.0.0 リリースで修正された問題](../release-info/fixed-issues-5-0-0.md)」を参照してください。

5.0.0 リリース ](../release-info/upgrade-instructions-5-0-0.md)の[ アップグレード手順について説明します。
...
新しいリリースの一部として、次のレビューの機能強化が行われました。
...
詳しくは、マップコンソール ](../user-guide/reports-web-editor.md)の[DITA マップレポートを参照してください。
