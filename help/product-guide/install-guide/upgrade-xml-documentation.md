...
Experience Manager Guidesの現在のバージョンを 4.6.0 サービスパック 1 にアップグレードできます。
...
>[!TIP]
>
> バージョン 4.6.0 に Service Pack 1 をインストールすることをお勧めします。4.6.0 サービスパック 1 リリースのアップグレードプロセスは、4.6.0 リリースと同じ手順に従います。
