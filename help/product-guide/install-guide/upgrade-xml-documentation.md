...
>[!TIP]
>
> バージョン 5.0.0 サービスパック 3 へのアップグレードは、Experience Manager Guidesの現在のバージョンによって異なります。 バージョン 5.0.0 サービスパック 2、5.0.0 サービスパック 1 または 5.0.0 を使用している場合は、バージョン 5.0.0 サービスパック 3 に直接アップグレードできます。
