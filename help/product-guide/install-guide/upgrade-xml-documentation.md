...
Experience Manager Guidesの現在のバージョンをバージョン 4.6.1 にアップグレードするには、次の手順を実行します。
...
>[!TIP]
>
> バージョン 4.6.0 に Hotfix 4.6.1 をインストールすることをお勧めします。4.6.1 リリースのアップグレードプロセスは、4.6.0 リリースと同じ手順に従います。
