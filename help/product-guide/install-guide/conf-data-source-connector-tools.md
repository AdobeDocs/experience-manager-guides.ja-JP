...
データソースを設定すると、コネクタはエディターの&#x200B;**データソースパネル**&#x200B;の下に表示されます。 次に、データソースに接続し、トピックにコンテンツスニペットを挿入します。 詳しくは、[&#x200B; データソースからのデータを使用](../user-guide/web-editor-content-snippet.md)を参照してください。
