---
user-guide-title: Experience Manager Guides オールド UI
user-guide-description: 従来のユーザーインターフェイスを利用したAdobe Experience Manager Guidesの製品ドキュメントをご確認ください。
breadcrumb-title: AEM Guides ドキュメント
hide: true
badgeAll: label="古いUI ガイド – 詳細情報" type="Informative" url="/help/legacy-product-guide/disclaimer.md" tooltip="古いUI ガイド"
...
- ユーザーガイド（旧UI） {#user-guide}
   ...
   - 作成者コンテンツ {#author-content}
      ...
      - トピックの作成とプレビュー {#create-preview-topics}
         ...
         - コンテンツの作成 {#author-content-aem-guides}
            - [AEM Guidesを使用してコンテンツを作成する方法](./user-guide/authoring-content-xml-doc.md)
            - web エディター {#work-with-web-editor}
               ...
               - [Web エディターの機能](./user-guide/web-editor-features.md)
               ...
               - [AIを活用したスマートな提案によるコンテンツの作成](./user-guide/authoring-ai-based-smart-suggestions.md)
               - [AIを活用したスマートヘルプでコンテンツを検索](./user-guide/ai-based-smart-help.md)
               - [AI アシスタントにより、スマートに効率よくドキュメントを作成](./user-guide/ai-assistant-right-panel.md)
               - [Web エディターからMarkdown ドキュメントを作成する](./user-guide/web-editor-markdown-topic.md)
               - [コンテンツに引用を追加する](./user-guide/web-editor-apply-citations.md)
               - [データソースからのデータを利用する](./user-guide/web-editor-content-snippet.md)
               ...
               - 記事ベースの公開 {#article-based-pub}
                  ...
                  - [リポジトリーパネルまたはマップビューパネルから出力を生成](./user-guide/web-editor-article-publishing-output.md)
               ...
               - [Web エディターでのベースラインの作成と管理](./user-guide/web-editor-baseline.md)
               - [ドキュメントの状態](./user-guide/web-editor-document-states.md)
               - [ラベルを使用](./user-guide/web-editor-use-label.md)
            - マップエディター {#work-with-map-editor}
               - [マップエディターの操作](./user-guide/map-editor.md)
               - [マップの作成](./user-guide/map-editor-create-map.md)
               - [カスタマイズされたテンプレートに基づくマップの作成](./user-guide/create-maps-customized-templates.md)
               - [高度なマップエディターの操作](./user-guide/map-editor-advanced-map-editor.md)
               - [基本マップエディターの操作](./user-guide/map-editor-basic-map-editor.md)
               - [マップエディターのその他の機能](./user-guide/map-editor-other-features.md)
            - DITAVAL エディター {#ditaval-editor}
               - [DITAVAL エディターの操作](./user-guide/ditaval-editor.md)
         - コンテンツ制作のためのデスクトップツール {#author-using-desktop-tools}
            - [デスクトップツールを使用したコンテンツの作成](./user-guide/author-desktop-tools.md)
            - [FrameMakerの操作](./user-guide/author-desktop-framemaker.md)
            - [Oxygenの使用](./user-guide/author-desktop-oxygen.md)
   - コンテンツを見る {#review-topic-maps}
      - [トピックまたはマップの確認](./user-guide/review.md)
      ...
      - トピックレビュー {#review-topics}
         - [トピックを見る](./user-guide/review-topics.md)
         - [アドレス確認コメント](./user-guide/review-address-review-comments.md)
   ...
   - AEM Guidesのメタデータ {#manaege-metadata}
   ...
   - コンテンツの翻訳 {#translate-content}
      ...
      - [変更したトピックの翻訳](./user-guide/translation-modified-topics-6234.md)
   - 出力生成 {#output-gen}
      - [出力生成の基本](./user-guide/generate-output.md)
      - [出力プリセットについて](./user-guide/generate-output-understand-presets.md)
      - AEM Guidesの出力プリセット {#output-presets-aemg}
         - [AEMサイト](./user-guide/generate-output-aem-site.md)
         - [マップダッシュボード上のAEM Sites プリセット](./user-guide/generate-output-aem-site-map-dashboard.md)
      ...
      - [マップコンソールからDITA マップの出力を生成する](./user-guide/generate-output-for-a-dita-map.md)
      ...
      - コンテンツの一括アクティベーション {#bulk-activation}
         - [公開したコンテンツの一括アクティベーション](./user-guide/conf-bulk-activation.md)
         - [一括アクティベーションマップコレクションの作成](./user-guide/conf-bulk-activation-create-map-collection.md)
         - [出力をアクティブ化](./user-guide/conf-bulk-activation-publish-map-collection.md)
   ...
   - FrameMaker ドキュメントの出力生成 {#generate-fm-output}
      ...
      - サポートされているプリセット {#fm-docs-generating-presets}
         - [FrameMaker ドキュメントを作成するためのプリセット](./user-guide/fm-output-understand-presets.md)
         - [PDF](./user-guide/fm-output-pdf-preset.md)
         - [HTML5](./user-guide/fm-output-html5-preset.md)
         - [EPUB](./user-guide/fm-output-epub-preset.md)
      - [.book ファイルまたは.fm ファイルの出力を生成](./user-guide/fm-output-generate.md)
      - [出力生成タスクのステータスの表示](./user-guide/fm-output-view-status.md)
   - AEM Guidesのレポート {#reports-aem-guide}
      - [レポートの概要](./user-guide/reports-intro.md)
      - [Web エディターからのDITA マップレポート](./user-guide/reports-web-editor.md)
      - [マップダッシュボードのDITA マップレポート](./user-guide/reports-ditamap.md)
