...
1. 「**クラウドサービス**」タブで、使用する翻訳サービスを設定します。
   ...
   >[!NOTE]
   >
   > サードパーティの翻訳サービスとの連携について詳しくは、AEM ドキュメントの[翻訳統合フレームワークの設定](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/administering/reusing-content/translation/integration-framework.html?lang=ja)を参照してください。
