...
| ファイル階層の統合 | 「」オプションを選択すると、フラットなフォルダー階層でHTML 5 の出力を生成します。 コンテンツ全体がフラットなファイル階層でHTML5 出力フォーマットで公開され、1 つのフォルダーに保存されます。 <br> このオプションの選択を解除すると、出力はネストされたフォルダー階層に生成され、フォルダー構造全体がレプリケートされます。 |
