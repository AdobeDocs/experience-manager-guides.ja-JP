...
- これらの定義済みテンプレートに基づいて [&#x200B; ホームページを作成 &#x200B;](/help/product-guide/cs-install-guide/download-install-aem-sites-templates-cs.md#create-a-home-page-using-the-template) します。
