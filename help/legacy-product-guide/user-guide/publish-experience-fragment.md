...
1. **エクスペリエンスフラグメントを生成** ダイアログボックスで、次の詳細を入力します。
   ...
   * **マッピング**: *experienceFragmentMapping.json* ファイルからマッピングを選択して表示します。
     ...
     管理者は、*experienceFragmentMapping.json* ファイルにマッピングを追加できます。  トピックとエクスペリエンスフラグメント [&#128279;](/help/product-guide/cs-install-guide/conf-experience-fragment-mapping-cs.md)の間のマッピングを作成する方法については、インストールおよび設定ガイドを参照してください。
