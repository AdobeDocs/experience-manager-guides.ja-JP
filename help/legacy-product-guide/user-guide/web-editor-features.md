...
- **パブリッシュプロファイル**: **ナレッジベース** 出力の公開に使用できるパブリッシュプロファイルが含まれています。 ターゲットのナレッジベース用に新しいプロファイルを作成できます。 例えば、Salesforceや ServiceNow などです。
  ...
  これらを使用して、Salesforce パブリッシュプロファイルを作成できます。
   ...
   - Salesforce公開プロファイルを作成するには、「{Server Type **」ドロップダウンから {0** Salesforce **ナレッジベースを選択します。**&#x200B;プロファイル名を入力します。 **サイト URL** に、出力の公開に使用するコンシューマーサイトを入力し、Salesforce コンシューマーサイトから提供される **コンシューマーキー** と **コンシューマーシークレット** を追加します。 次に、新しく作成したプロファイルを **検証** および **保存** します。
