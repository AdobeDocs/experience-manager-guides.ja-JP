...
1. 左側のパネルで「**データソース** ![](images/data-source-icon.svg)」を選択して、接続されたデータソースを表示します。
...
メインツールバーの&#x200B;**クエリスニペットの挿入** ![](images/data-source-icon.svg)を使用して、データスニペットをトピックに挿入することもできます。  ドロップダウンからジェネレーターを選択したり、クエリを編集したり、テンプレートを変更してトピックにデータを挿入したりできます。
